...
INSERT INTO REALTY_INCOME.AGENT.SEARCH_DOCUMENTS (DOC_ID, CHUNK_ID, DOC_TYPE, DOC_TITLE, DOC_DATE, FISCAL_YEAR, FISCAL_QUARTER, CHUNK_TEXT, METADATA)
SELECT 'KB-001', 1, 'Knowledge Base', 'REIT Fundamentals', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-002', 1, 'Knowledge Base', 'Key REIT Metrics Explained', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-003', 1, 'Knowledge Base', 'Realty Income Company Overview', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-004', 1, 'Knowledge Base', 'Net Lease Structure Benefits', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-005', 1, 'Knowledge Base', 'Portfolio Diversification Strategy', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-006', 1, 'Knowledge Base', 'Interest Rate Impact on REITs', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-007', 1, 'Knowledge Base', 'Investment Grade Tenant Analysis', '2025-01-01'::DATE, 2025, 1,
...
UNION ALL SELECT 'KB-008', 1, 'Knowledge Base', 'European Expansion Strategy', '2025-01-01'::DATE, 2025, 1,
